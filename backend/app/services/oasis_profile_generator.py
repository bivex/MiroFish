...
class OasisProfileGenerator:
    ...
    def __init__(
        ...
        self.model_name = model_name or Config.get_stage_model('profile')
        self.graph_backend = (graph_backend or Config.get_graph_backend()).lower()
        ...
        if self.graph_backend == 'zep' and self.zep_api_key:
            try:
    ...
    def _generate_profile_rule_based(
        ...
        if entity_type_lower in ["student", "alumni"]:
            return {
                ...
                "persona": f"{entity_name} is a {entity_type.lower()} who actively participates in the current scenario, shares perspectives, and engages with peers and institutions when relevant.",
            ...
            return {
                "bio": f"Public communication channel for {entity_name}. News, signals, and updates.",
                "persona": f"{entity_name} is a media-oriented entity that reports developments and shapes public understanding of events. This channel shares timely updates, signals, and reactions relevant to the scenario.",
                "age": 30,  # 机构虚拟年龄
                "gender": "other",  # 机构使用other
                "mbti": "ISTJ",  # 机构风格：严谨保守
                "country": "Unspecified Region",
                "profession": "Media",
                "interested_topics": ["General News", "Emerging Events", "Public Affairs"],
            }
        
        elif entity_type_lower in ["university", "governmentagency", "ngo", "organization"]:
            return {
                "bio": f"Representative public channel of {entity_name}.",
                "persona": f"{entity_name} is an institutional entity that communicates official positions, announcements, directives, and responses to relevant stakeholders within the scenario.",
                "age": 30,  # 机构虚拟年龄
                "gender": "other",  # 机构使用other
                "mbti": "ISTJ",  # 机构风格：严谨保守
                "country": "Unspecified Region",
            ...
            return {
                ...
                "persona": entity_summary or f"{entity_name} is a {entity_type.lower()} participating in the current scenario and responding according to their role.",
        ...
        def generate_single_profile(idx: int, entity: EntityNode) -> tuple:
            ...
            try:
                ...
                fallback_profile = OasisAgentProfile(
                    ...
                    persona=entity.summary or f"A participant in the current scenario.",
                    source_entity_uuid=entity.uuid,
                    source_entity_type=entity_type,
                )
            ...
            for future in concurrent.futures.as_completed(future_to_entity):
                ...
                try:
                    ...
                    profiles[idx] = OasisAgentProfile(
                        ...
                        name=entity.name,
                        bio=f"{entity_type}: {entity.name}",
                        persona=entity.summary or "A participant in the current scenario.",
                        source_entity_uuid=entity.uuid,
                        source_entity_type=entity_type,
                    )
                    # 实时写入文件（即使是备用人设）
    ...
    def _save_reddit_json(self, profiles: List[OasisAgentProfile], file_path: str):
        ...
        for idx, profile in enumerate(profiles):
            ...
            item = {
                ...
                "persona": profile.persona or f"{profile.name} is a participant in the current scenario.",
                ...
                "country": profile.country if profile.country else "Unspecified Region",
            }
