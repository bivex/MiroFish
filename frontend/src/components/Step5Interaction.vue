          ...
          <div class="action-bar-tabs">
            ...
            <div class="agent-dropdown" v-if="profiles.length > 0">
              ...
              >
                ...
                <span>{{ selectedAgent ? selectedAgent.username : 'Chat with any in-world agent' }}</span>
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">A fast chat interface for the report agent with 4 professional tools and full MiroFish memory.</div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Aligns real-world seed data with simulation state and uses Global / Local Memory to deliver cross-temporal attribution analysis.</div>
                  </div>
                </div>
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">PanoramaSearch Full-path Tracing</div>
                    <div class="tool-desc">Reconstructs event propagation paths with graph traversal and captures the full topology of information flow.</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">An instant GraphRAG query interface optimized for quickly retrieving concrete node attributes and discrete facts.</div>
                  </div>
                </div>
...
const submitSurvey = async () => {
  ...
  try {
    ...
    addLog(`Survey delivery failed: ${err.message}`)
  } finally {
